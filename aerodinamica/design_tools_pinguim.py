...
def my_aircraft():
    ...
    wing = {'S':78.96, #Atualizado para nossa aeronave por regressão por MTOW
    		'AR':8.43, #Otimizar no acompanhamento
    		'taper':0.235,
    		'sweep':17.45*np.pi/180,  #Otimizar no acompanhamento
    ...
    EH  =  {'Cht':1.52, #Atualizado para nossa aeronave por regressão por MTOW
    		'AR':4.64,
    		'taper':0.39,
    		'sweep':26*np.pi/180,
    ...
    EV  =  {'Cvt':0.1, #Atualizado pelos vozes da nossa cabeça
    		'AR':1.27,
    		'taper':0.74,
    		'sweep':41*np.pi/180,
    		'Lb':0.55,
    ...
    weights = {'W_payload': 12695*9.81, #Atualizado com da cabine.
               'xcg_payload': 14.4,
               'W_crew': 4*80*9.81,     #Atualizado com da cabine.
               'xcg_crew': 2.5,
    ...
    fus = {'Lf': 30.20, #Atualizado para a nossa aeronave
           'Df': 3.57}  #Atualizado para a nossa aeronave
